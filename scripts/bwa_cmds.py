...
for filename in os.listdir(".") :
    ...
    bwa_cmd = "#/storage/home/users/pjt6/shelf_apps/apps/bwa-mem2-2.0pre2_x64-linux/bwa-mem2 mem -t 32 /storage/home/users/Michael_Ritchie/DROS_kitchenMadness_DNAseq_20211207/genome/dmel-all-chromosome-r6.43.fasta %s_R1_paired.fq.gz %s_R2_paired.fq.gz | samtools view -b -o ../bams/%s.bam - \n\n" % (prefix, prefix, prefix)
    #print(bwa_cmd)
    f_out.write(top)
    f_out.write(bwa_cmd)
