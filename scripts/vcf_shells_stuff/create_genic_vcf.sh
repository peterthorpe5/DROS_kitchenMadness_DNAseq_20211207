...
vcftools --gzvcf dmel_kitcthen_flies.glnexus.r6.43.with_extra_split_genic.vcf \
--mac 1  \
...
vcftools --TajimaD 10000 --gzvcf dmel_kitcthen_flies.glnexus.r6.43.with_extra_split_genic.vcf  \
...
vcftools --TajimaD 5000 --gzvcf dmel_kitcthen_flies.glnexus.r6.43.with_extra_split_genic.vcf  \
 --indv F2014_female_fall_DrosEU_match --indv F2015_female_fall_DrosEU_match --indv Fly_MaleA \
 --indv Fly_MaleB --indv Fly_femaleA --indv Fly_femaleB --indv MR19female1 --indv MR19female2 --indv MR19male1 \
 --indv MR19male2 --indv MR20female1 --indv MR20female2 --indv MR20male1 --indv MR20male2 --indv MR_female --indv MR_male \
 --out TajD_5k_genic_no_indels
 
 vcftools --TajimaD 15000 --gzvcf dmel_kitcthen_flies.glnexus.r6.43.with_extra_split_genic.vcf  \
 --indv F2014_female_fall_DrosEU_match --indv F2015_female_fall_DrosEU_match --indv Fly_MaleA \
 --indv Fly_MaleB --indv Fly_femaleA --indv Fly_femaleB --indv MR19female1 --indv MR19female2 --indv MR19male1 \
 --indv MR19male2 --indv MR20female1 --indv MR20female2 --indv MR20male1 --indv MR20male2 --indv MR_female --indv MR_male \
