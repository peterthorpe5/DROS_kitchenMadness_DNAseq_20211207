...
gatk --java-options "-Xmx120g" GenomicsDBImport   --reader-threads 20 -V ../F2014_female_fall_DrosEU_match.g.vcf.gz \
...
# https://github.com/broadinstitute/gatk/issues/7639   after error
gatk --java-options "-Xmx250g" GenotypeGVCFs --max-alternate-alleles 55 -R "/storage/home/users/pjt6/kitchen_flies/genome/dmel-all-chromosome-r6.43.fasta" -V gendb://allsamples -all-sites -L ../dmel-all-chromosome-r6.43.bed -O dmelr6.43_kitchen_madness-allsites.vcf.gz
